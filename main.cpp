...
class sxMegaInt {
    public:
        ...
        std::string to_string()  { return mValue.to_string(); }
        std::string to_decimal() { return to_decimal(mValue); }
...
int main() {
    ...
    std::cout << "D-ANSWER: " << ans5.to_decimal() << std::endl;
    ...
    std::cout << "D-ANSWER: " << ans6.to_decimal() << std::endl;
    std::cout << "L-ANSWER: " << ans6.to_llong() << "\n\n";

    ans6 /= -20;
    std::cout << "SHOULD BE: -377.50" << std::endl;
    std::cout << "D-ANSWER: " << ans6.to_decimal() << std::endl;
    std::cout << "L-ANSWER: " << ans6.to_llong() << "\n\n";
    ...
    for(int i = 0; i < 100; i++) {
        ans6 = ans7.power(i);
        std::cout << "2^" << std::to_string(i) << ": " << ans6.to_decimal() << std::endl;
    }
    std::cout << "\n";

    ans7 = "123123132131";
    std::cout << "STRING ASSIGN EXPECTED: 123123132131 " << "\n";
    std::cout << "D-ANSWER: " << ans7.to_decimal() << "\n\n";
    ...
    std::cout << "D-ANSWER: " << ans8.to_decimal() << "\n\n";
